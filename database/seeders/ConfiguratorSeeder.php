...
class ConfiguratorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Storage
        \App\Models\Storage::create(['name' => '1TB NVMe PCIe 4.0 SSD', 'type' => 'NVMe Gen4', 'capacity' => 1000, 'price' => 3800, 'cache' => '1GB DRAM', 'form_factor' => 'M.2 2280', 'interface' => 'PCIe 4.0 x4']);
        \App\Models\Storage::create(['name' => '2TB NVMe PCIe 4.0 SSD', 'type' => 'NVMe Gen4', 'capacity' => 2000, 'price' => 6500, 'cache' => '2GB DRAM', 'form_factor' => 'M.2 2280', 'interface' => 'PCIe 4.0 x4']);
        \App\Models\Storage::create(['name' => '2TB NVMe PCIe 5.0 SSD', 'type' => 'NVMe Gen5', 'capacity' => 2000, 'price' => 12500, 'cache' => '4GB DRAM', 'form_factor' => 'M.2 2280', 'interface' => 'PCIe 5.0 x4']);
        ...
        \App\Models\Cooler::create(['name' => 'Thermalright Peerless Assassin 120', 'price' => 2500, 'fan_rpm' => '1550 RPM', 'noise_level' => '25.6 dB(A)', 'color' => 'White', 'radiator_size' => 'N/A']);
