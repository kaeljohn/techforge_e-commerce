    ...
    public function run(): void
    {
        ...
        $builds = [
            ...
            [
                ...
                'cooler_id' => \App\Models\Cooler::where('name', 'Thermalright Peerless Assassin 120')->first()->id ?? 2,
                'price' => 110000,
            ...
            [
                ...
                'cooler_id' => \App\Models\Cooler::where('name', 'NZXT Kraken 240 RGB Liquid Cooler')->first()->id ?? 3,
                'price' => 250000,
            ...
            [
                ...
                'power_supply_id' => PowerSupply::where('name', 'like', '%1000%')->first()->id ?? 3,
                'pc_case_id' => PcCase::skip(2)->first()->id ?? 3,
                'cooler_id' => \App\Models\Cooler::where('name', 'Corsair iCUE Link H150i RGB')->first()->id ?? 3,
                'price' => 260000,
