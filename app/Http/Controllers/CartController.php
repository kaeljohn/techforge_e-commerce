...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        $models = [
            \App\Models\AccessoryKeyboard::class,
            \App\Models\AccessoryHeadset::class,
            \App\Models\AccessoryMouse::class,
            \App\Models\AccessoryMousePad::class,
            \App\Models\AccessoryMonitor::class,
        ];
        ...
        return view('cart', compact('cart', 'subtotal', 'shipping', 'discount', 'total', 'freeShippingThreshold', 'recommendations'));
    }
