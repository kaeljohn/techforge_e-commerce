...
class LaptopController extends Controller
{
    ...
    public function index()
    {
        ...
        $laptops = $laptops->map(function($laptop) {
            $laptop->html_card = view('components.product-card2', ['config' => $laptop, 'type' => 'laptop'])->render();
            return $laptop;
        });
        ...
        return view('gaming-laptops', compact('laptops', 'counts', 'globalMinPrice', 'globalMaxPrice'));
    }
