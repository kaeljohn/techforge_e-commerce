document.addEventListener('DOMContentLoaded', function() {
    ...
    const searchTab = new URLSearchParams(window.location.search).get('tab') || 'prebuilt';
    let currentPage = 1;
    ...
    function renderProducts(products) {
        ...
        currentProducts.forEach(config => {
            const imageUrl = config.image_url || 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?auto=format&fit=crop&w=800&q=80';
