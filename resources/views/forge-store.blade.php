...
<body class="relative antialiased selection:bg-primary selection:text-white">
    ...
    <div class="max-w-[1500px] mx-auto px-6 lg:px-8 pb-24 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Accessories -->
            <a href="{{ route('store.accessories') }}" class="group relative overflow-hidden rounded-2xl liquid-glass-heavy border border-white/5 hover:border-primary/50 transition-all duration-300 p-8 flex flex-col items-center justify-center text-center aspect-[4/3] md:aspect-auto md:h-64">
            ...
            <!-- Monitors -->
            <a href="{{ route('store.monitors') }}" class="group relative overflow-hidden rounded-2xl liquid-glass-heavy border border-white/5 hover:border-primary/50 transition-all duration-300 p-8 flex flex-col items-center justify-center text-center aspect-[4/3] md:aspect-auto md:h-64">
            ...
            <!-- PC Parts -->
            <a href="{{ route('store.pc-parts') }}" class="group relative overflow-hidden rounded-2xl liquid-glass-heavy border border-white/5 hover:border-primary/50 transition-all duration-300 p-8 flex flex-col items-center justify-center text-center aspect-[4/3] md:aspect-auto md:h-64">
