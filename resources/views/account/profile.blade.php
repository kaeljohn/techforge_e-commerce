                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-col ml-8 gap-3 border-l border-white/10 pl-4 py-1">
                                <a href="{{ route('account.profile') }}" class="text-primary font-bold text-sm hover:text-primary transition-colors">Profile</a>
                        ...
                        <!-- Other Categories -->
                        <a href="{{ route('account.purchases') }}" class="flex items-center gap-3 text-gray-400 hover:text-white transition-colors font-bold text-base mt-4">
