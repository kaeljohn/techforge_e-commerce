...
<body class="relative antialiased selection:bg-primary selection:text-white">
    ...
    <!-- Category Content -->
    <form id="filter-form" method="GET" action="{{ route('gaming-laptops') }}" class="max-w-[1500px] mx-auto px-6 lg:px-8 pb-24 relative z-10 flex flex-col lg:flex-row gap-8">
