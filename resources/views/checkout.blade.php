                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" id="firstName" name="firstName" required class="form-input" value="{{ explode(' ', auth()->user()->name)[0] ?? '' }}">
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Last Name</label>
                                <input type="text" id="lastName" name="lastName" required class="form-input" value="{{ explode(' ', auth()->user()->name)[1] ?? '' }}">
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Email Address</label>
                                <input type="email" required class="form-input" value="{{ auth()->user()->email }}" readonly>
                            </div>
                            <div class="sm:col-span-2">
